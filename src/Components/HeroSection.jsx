            ...
            <div className="container mx-auto py-8 px-6 lg:py-16 lg:px-6">
                <div className="grid md:grid-cols-2 gap-8 justify-center items-center relative z-10	">
                    ...
                    <div className="relative flex justify-center z-10	">
                        ...
                        <div className=' absolute  -top-2 md:-top-8 right-24 decoration  max-sm:hidden max-md:hidden'>
                            <img
                                src={decorationImg}
                                alt="Main Mentor"
                                className=" "
                        ...
                        <div className="absolute -bottom-4 md:-bottom-8 left-4 md:-left-4 bg-prime p-4 rounded-lg bg-secondary-3 items-center space-x-2" style={{ boxShadow: '8px 6px 0 0 #ffbcbc' }}>
                            <div className="flex flex-col items-start space-y-2 pb-2 ">
                                <h2 className="text-sm md:text-xl font-semibold">UI Design Pattern</h2>
                                <div className="flex items-center space-x-4">
                                    <img src={heroImg4} alt="Avatar" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full" />
                                    <div className="flex flex-col">
                                        <div className="text-lg font-normal font-Helvetica">Dennis Barrett</div>
